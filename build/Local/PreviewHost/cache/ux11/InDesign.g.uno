...
public partial class InDesign: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        temp1.LineNumber = 3;
        temp1.FileName = "Pages/InDesign.ux";
        ...
        temp14.Density = 1f;
        temp14.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../Pages/Assets/Images/indesign_logo.png"));
        temp15.Density = 2f;
        temp15.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../Pages/Assets/Images/indesign_logo@2x.png"));
        temp16.Density = 3f;
        temp16.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../Pages/Assets/Images/indesign_logo@3x.png"));
        Bar1.Name = __selector1;
        Bar1.Text = "9.5";
        Bar1.Percentage = new Uno.UX.Size(0f, Uno.UX.Unit.Percent);
        Bar1.Stop1 = float4(0.8901961f, 0.2117647f, 0.5843138f, 1f);
        Bar1.Stop2 = float4(0.9137255f, 0.3254902f, 0.6666667f, 1f);
        temp18.Value = "Many a magazine, eBook or interactive layout has added to my InDesign skillset.";
        ...
        temp21.Uri = "https://www.behance.net/gallery/28395839/Magazine-Layout-Crumbs";
