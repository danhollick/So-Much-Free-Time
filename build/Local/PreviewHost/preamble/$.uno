...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.1.7"), 12124)}, "/Users/tanyahirst/Documents/Personal/Tanya CV/Tanya_CV.unoproj", GetBundle, new string[] { ""})
{
...
{
return Uno.IO.Bundle.Get("Tanya_CV");
}
}
}
