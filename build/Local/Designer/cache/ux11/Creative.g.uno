...
public partial class Creative: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        temp4.Handler += temp_eb10.OnEvent;
        ...
        Stroke1.Text = "8.5";
        temp11.Value = "Research, understanding and sound understanding of platforms is key to creating the best piece of design to reach and impact your audience in the right way.  I’ve always been one to put as much creativity into the strategy as I do in the execution.";
