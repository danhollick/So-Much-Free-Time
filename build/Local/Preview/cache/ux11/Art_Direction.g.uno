...
public partial class Art_Direction: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        Stroke1.Text = "8.0";
        temp12.Value = "I believe these two go hand in hand, understanding what makes up a brilliant image is just as valuable as taking a technically perfect shot. \nI’m proud of the fact that I can perfect what I’m looking at, and also be the one to capture it.";
